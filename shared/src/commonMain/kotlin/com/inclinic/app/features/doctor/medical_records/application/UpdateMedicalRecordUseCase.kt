...
import com.inclinic.app.features.doctor.infrastructure.remote.UpdateMedicalRecordRequest
...
class UpdateMedicalRecordUseCase(
    ...
    suspend operator fun invoke(recordId: String, draft: MedicalRecordDraft): Result<MedicalRecord> =
        withContext(dispatchers.io) {
            ...
            dataSource.updateMedicalRecord(
                recordId,
                UpdateMedicalRecordRequest(
                    diagnosis = draft.diagnosis.takeIf { it.isNotBlank() },
                    symptoms = draft.symptoms.takeIf { it.isNotBlank() },
                    treatment = draft.treatment.takeIf { it.isNotBlank() },
