...
/** Fetches a single pending doctor's full detail via GET /api/doctors/:id/pending. */
class GetPendingDoctorByIdUseCase(
    private val dataSource: AdminDataSource,
    private val dispatchers: AppDispatchers,
) {
    suspend operator fun invoke(id: String): Result<AdminPendingDoctor> =
        withContext(dispatchers.io) { dataSource.getPendingDoctorById(id) }
}
